...
class Page extends Model
{
    ...
    public function getSlugs(): array { return $this->id ? Slug::forEntity('page', $this->id) : []; }
    public function getSlug(string $lang = 'en'): string { return $this->id ? Slug::get('page', $this->id, $lang) : ''; }
